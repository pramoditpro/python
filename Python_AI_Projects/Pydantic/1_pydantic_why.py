...
from typing import List, Dict, Optional, Annotated #Python 3.14 natively supports types like list and dict without needing the typing module imports. You would only need to keep Annotated
